...
public class Day17A extends AppCompatActivity {
TextView t1,t2,t3,t4,t5,t6,t7,t8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t3=(TextView)findViewById(R.id.textView35);
        t4=(TextView)findViewById(R.id.textView36);
        t5=(TextView)findViewById(R.id.textView37);
        t6=(TextView)findViewById(R.id.textView38);
        t7=(TextView)findViewById(R.id.textView39);
        t8=(TextView)findViewById(R.id.textView40);
